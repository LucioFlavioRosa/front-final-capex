 ...
 *
 * Existe por causa do caso de POUCOS ANOS: um plano de dois anos ocupando a
 * largura inteira vira duas lajes gigantes, que leem como blocos decorativos e
 * não como tempo. Com o teto, dois anos ocupam a esquerda do quadro e o vazio à
 * direita diz uma coisa verdadeira — o horizonte é curto.
 */
const LARGURA_MAX = 56
